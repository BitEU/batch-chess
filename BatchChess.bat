...
@REM Last Updated: December 28, 2012
mode 80,30

::  By Kolto101  ::

REM This is an old game, and there are bad uses of goto, but
REM I am not actively maintaining it.
...
echo             ,::::::^<                                        ^>::::::,
echo            ,::/^^\"``.                                      .``"/^^\::,
echo           ,::/, `   O`.        …ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕª        .`O   ` ,\::,
echo          ,::; ^|        '.      ∫     -Menu-     ∫      .'        ^| ;::,
echo          ,::^|  \___,-.  o)     ÃÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕπ     (o  .-,___/  ^|::,
echo          ;::^|     \   '-'      ∫  1. Play       ∫      `-'   /     ^|::;
echo          ;::^|      \           ∫  2. Load Game  ∫           /      ^|::;
...
:las
set lastmove=Last move: [!piece!] !v_file1!!v_rank1!  ƒ^!ar!  !v_file2!!v_rank2!
...
echo     8!r1! !ver! !a1! !ve2! !a2! !ve2! !a3! !ve2! !a4! !ve2! !a5! !ve2! !a6! !ve2! !a7! !ve2! !a8! !ver!  8   [!piece!] !v_file1!!v_rank1!  ƒ^>  !v_file2!!v_rank2!
...
echo        !tlc!!bar!!tcn!!bar!!tcn!!bar!!tcn!!bar!!tcn!!bar!!tcn!!bar!!tcn!!bar!!tcn!!bar!!trc!
echo     A!f1! !ver! !a57! !ve2! !a49! !ve2! !a41! !ve2! !a33! !ve2! !a25! !ve2! !a17! !ve2! !a9! !ve2! !a1! !ver!  A   [!piece!] !v_file1!!v_rank1!  ƒ^>  !v_file2!!v_rank2!
echo        !lcn!!ba2!!cro!!ba2!!cro!!ba2!!cro!!ba2!!cro!!ba2!!cro!!ba2!!cro!!ba2!!cro!!ba2!!rcn!
...
echo        !tlc!!bar!!tcn!!bar!!tcn!!bar!!tcn!!bar!!tcn!!bar!!tcn!!bar!!tcn!!bar!!tcn!!bar!!trc!
echo     1!r8! !ver! !a64! !ve2! !a63! !ve2! !a62! !ve2! !a61! !ve2! !a60! !ve2! !a59! !ve2! !a58! !ve2! !a57! !ver!  1   [!piece!] !v_file1!!v_rank1!  ƒ^>  !v_file2!!v_rank2!
echo        !lcn!!ba2!!cro!!ba2!!cro!!ba2!!cro!!ba2!!cro!!ba2!!cro!!ba2!!cro!!ba2!!cro!!ba2!!rcn!
...
echo        !tlc!!bar!!tcn!!bar!!tcn!!bar!!tcn!!bar!!tcn!!bar!!tcn!!bar!!tcn!!bar!!tcn!!bar!!trc!
echo     A!f1! !ver! !a8! !ve2! !a16! !ve2! !a24! !ve2! !a32! !ve2! !a40! !ve2! !a48! !ve2! !a56! !ve2! !a64! !ver!  A   [!piece!] !v_file1!!v_rank1!  ƒ^>  !v_file2!!v_rank2!
echo        !lcn!!ba2!!cro!!ba2!!cro!!ba2!!cro!!ba2!!cro!!ba2!!cro!!ba2!!cro!!ba2!!cro!!ba2!!rcn!
...
cls
echo.
echo    ⁄ƒƒƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒø
echo    ≥  Type  ≥ White ≥ Black ≥
echo    √ƒƒƒƒƒƒƒƒ≈ƒƒƒƒƒƒƒ≈ƒƒƒƒƒƒƒ¥
...
echo    ¿ƒƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒŸ
echo.
pause
)
...
echo.
echo Save game for playback? [Note: doesn't work for loaded games. Fix this.]
echo.
...
echo          A   B   C   D   E   F   G   H
echo.  
echo        …ÕÕÕ—ÕÕÕ—ÕÕÕ—ÕÕÕ—ÕÕÕ—ÕÕÕ—ÕÕÕ—ÕÕÕª
echo     8  ∫!a1!≥!a2!≥!a3!≥!a4!≥!a5!≥!a6!≥!a7!≥!a8!∫  8    [!piece!] !file1!!rank1! ƒ^!ar! !file2!!rank2!
echo        «ƒƒƒ≈ƒƒƒ≈ƒƒƒ≈ƒƒƒ≈ƒƒƒ≈ƒƒƒ≈ƒƒƒ≈ƒƒƒ∂
...
echo        »ÕÕÕœÕÕÕœÕÕÕœÕÕÕœÕÕÕœÕÕÕœÕÕÕœÕÕÕº
echo.  
echo          A   B   C   D   E   F   G   H
exit /b
...
echo             Batch Chess                                  __
echo                                                         /  \
echo   Entirely scripted and produced by    "We're all       \__/
echo               Kolto101                                 /____\     in the game
echo                                           just pawns    ^|  ^|   
...
echo.
echo.
echo  b/Back   y/Kolto101's Youtube
echo.
...
cls
echo.
echo  …ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕª
echo  ∫       Configure       ∫
echo  ÃÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕπ
...
set tb=Black
echo.
echo  …ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕª
echo  ∫            Settings            ∫
echo  ÃÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕπ
echo  ∫                                ∫
...
echo  ∫                                ∫
echo  ∫      Press b to go back        ∫
echo  »ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕº
echo.
set /p choose=Choose a number: 
...
cls
echo.   
echo    ⁄ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒø
echo    ≥                        ≥
...
if "!symbolnum!" == "128" set symbol=Ä
if "!symbolnum!" == "129" set symbol=Å
if "!symbolnum!" == "130" set symbol=Ç
if "!symbolnum!" == "131" set symbol=É
if "!symbolnum!" == "132" set symbol=Ñ
if "!symbolnum!" == "133" set symbol=Ö
if "!symbolnum!" == "134" set symbol=Ü
if "!symbolnum!" == "135" set symbol=á
if "!symbolnum!" == "136" set symbol=à
if "!symbolnum!" == "137" set symbol=â
if "!symbolnum!" == "138" set symbol=ä
if "!symbolnum!" == "139" set symbol=ã
if "!symbolnum!" == "140" set symbol=å
if "!symbolnum!" == "141" set symbol=ç
if "!symbolnum!" == "142" set symbol=é
if "!symbolnum!" == "143" set symbol=è
if "!symbolnum!" == "144" set symbol=ê
if "!symbolnum!" == "145" set symbol=ë
if "!symbolnum!" == "146" set symbol=í
if "!symbolnum!" == "147" set symbol=ì
if "!symbolnum!" == "148" set symbol=î
if "!symbolnum!" == "149" set symbol=ï
if "!symbolnum!" == "150" set symbol=ñ
if "!symbolnum!" == "151" set symbol=ó
if "!symbolnum!" == "152" set symbol=ò
if "!symbolnum!" == "153" set symbol=ô
if "!symbolnum!" == "154" set symbol=ö
if "!symbolnum!" == "155" set symbol=õ
if "!symbolnum!" == "156" set symbol=ú
if "!symbolnum!" == "157" set symbol=ù
if "!symbolnum!" == "158" set symbol=û
if "!symbolnum!" == "159" set symbol=ü
...
if "!symbolnum!" == "174" set symbol=Æ
if "!symbolnum!" == "175" set symbol=Ø
...
if "!symbolnum!" == "185" set symbol=π
if "!symbolnum!" == "186" set symbol=∫
if "!symbolnum!" == "187" set symbol=ª
if "!symbolnum!" == "188" set symbol=º
if "!symbolnum!" == "189" set symbol=Ω
if "!symbolnum!" == "190" set symbol=æ
if "!symbolnum!" == "191" set symbol=ø
if "!symbolnum!" == "192" set symbol=¿
if "!symbolnum!" == "193" set symbol=¡
if "!symbolnum!" == "194" set symbol=¬
if "!symbolnum!" == "195" set symbol=√
if "!symbolnum!" == "196" set symbol=ƒ
...
if "!symbolnum!" == "203" set symbol=À
if "!symbolnum!" == "204" set symbol=Ã
if "!symbolnum!" == "205" set symbol=Õ
if "!symbolnum!" == "206" set symbol=Œ
if "!symbolnum!" == "207" set symbol=œ
...
if "!symbolnum!" == "216" set symbol=ÿ
if "!symbolnum!" == "217" set symbol=Ÿ
if "!symbolnum!" == "218" set symbol=⁄
if "!symbolnum!" == "219" set symbol=€
if "!symbolnum!" == "220" set symbol=‹
if "!symbolnum!" == "221" set symbol=›
if "!symbolnum!" == "222" set symbol=ﬁ
if "!symbolnum!" == "223" set symbol=ﬂ
...
if "!symbolnum!" == "229" set symbol=Â
if "!symbolnum!" == "230" set symbol=Ê
if "!symbolnum!" == "231" set symbol=Á
if "!symbolnum!" == "232" set symbol=Ë
if "!symbolnum!" == "233" set symbol=È
if "!symbolnum!" == "234" set symbol=Í
if "!symbolnum!" == "235" set symbol=Î
if "!symbolnum!" == "236" set symbol=Ï
if "!symbolnum!" == "237" set symbol=Ì
if "!symbolnum!" == "238" set symbol=Ó
if "!symbolnum!" == "239" set symbol=Ô
if "!symbolnum!" == "240" set symbol=
if "!symbolnum!" == "241" set symbol=Ò
if "!symbolnum!" == "242" set symbol=Ú
if "!symbolnum!" == "243" set symbol=Û
if "!symbolnum!" == "244" set symbol=Ù
if "!symbolnum!" == "245" set symbol=ı
if "!symbolnum!" == "246" set symbol=ˆ
